...
<!-- catalog:start -->
62 components across 4 categories:
...
- **Text Animations** (11) — type in motion: Morphing Text, Animated Number, Marquee Text, Variable Proximity, Scroll Velocity, Letters Pull, Word Reveal, Scramble Text, Long Shadow, Specter, Lumen.
- **Micro-interactions** (21) — small mechanisms, felt more than seen: Pixel Transition, Border Glow, Spotlight Shell, Animated Hamburger, Morph Dialog, Grow Dialog, Flip Card, Blueprint Card, Corner Letters, Hover List, Preloader, Circle Menu, Magnetic Button, Shadow Cursor, Torchlight, Dissolve, Tilt, Sigil, Rift, Unfold, Approach.
...
Components are tiered **free** (30) or **pro** (32). Pro source is gated server-side and never crosses to the client unless unlocked. The dev overrides (env `SHADOW_GARDEN_PRO=1`, cookie `sg_pro=1`) only apply in local development — in production the gate is entitlement-only.
<!-- catalog:end -->
