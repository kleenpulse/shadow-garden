...
<!-- catalog:start -->
29 components across 4 categories:
...
- **Micro-interactions** (7) — small mechanisms, felt more than seen: Pixel Transition, Border Glow, Spotlight Shell, Animated Hamburger, Morph Dialog, Grow Dialog, Flip Card.
- **Power-User Systems** (3) — command surfaces for operators: Sakura Tree, Command Palette, Physics Engine.

Components are tiered **free** (17) or **pro** (12). Pro source is gated server-side and never crosses to the client unless unlocked (env `SHADOW_GARDEN_PRO=1` or cookie `sg_pro=1`).
<!-- catalog:end -->
