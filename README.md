...
<!-- catalog:start -->
21 components across 4 categories:
...
- **Text Animations** (4) — type in motion: Morphing Text, Animated Number, Marquee Text, Variable Proximity.
- **Micro-interactions** (6) — small mechanisms, felt more than seen: Pixel Transition, Border Glow, Spotlight Shell, Animated Hamburger, Morph Dialog, Grow Dialog.
- **Power-User Systems** (2) — command surfaces for operators: Sakura Tree, Command Palette.

Components are tiered **free** (13) or **pro** (8). Pro source is gated server-side and never crosses to the client unless unlocked (env `SHADOW_GARDEN_PRO=1` or cookie `sg_pro=1`).
<!-- catalog:end -->
