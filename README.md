...
<!-- catalog:start -->
69 components across 4 categories:
...
Components are tiered **free** (33) or **pro** (36). Pro source is gated server-side and never crosses to the client unless unlocked. The dev overrides (env `SHADOW_GARDEN_PRO=1`, cookie `sg_pro=1`) only apply in local development — in production the gate is entitlement-only.
<!-- catalog:end -->
