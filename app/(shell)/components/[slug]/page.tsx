  ...
  return (
    <article className="mx-auto max-w-5xl space-y-8">
      ...
      <section className="space-y-3">
        <h2 className="font-display text-[11px] uppercase tracking-[0.2em] text-ink-mute">Install</h2>
        <Suspense fallback={<div className="h-20 animate-pulse rounded-lg border border-hairline bg-panel" />}>
          <InstallSection entry={entry} />
        </Suspense>
      </section>

      <section className="space-y-3">
        <h2 className="font-display text-[11px] uppercase tracking-[0.2em] text-ink-mute">Props</h2>
