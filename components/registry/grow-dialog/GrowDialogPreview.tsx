				...
				{CARDS.map((c, i) => {
					...
					return (
						<button
							...
							className="flex aspect-video flex-col items-start justify-center gap-3 rounded-xl border border-hairline bg-raised p-5 text-left transition-colors hover:border-accent/40 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/60 max-md:nth-[6]:hidden max-md:nth-[5]:hidden"
						>
