...
export const microInteractions: ComponentEntry[] = [
	...
	},
	{
		...
		dependencies: ["ogl"],
		cookbook: ["Drag", "Momentum", "Blur", "Loop"],
		variants: [
			{
				lang: "ts",
				style: "tailwind",
				file: "components/registry/refract/refract.tsx",
			},
			{
				lang: "ts",
				style: "tailwind",
		...
		props: [
			{
				...
				step: 0.01,
				description:
					"Refraction strength at the bevel. The flat middle passes almost straight through, exactly like a real pane.",
			},
			{
				name: "dispersion",
				kind: "number",
				...
				step: 0.05,
				description:
					"R/G/B sample spread — the chromatic fringe that gathers on the bevel.",
			},
			{
				name: "frost",
				kind: "number",
				...
				step: 0.5,
				unit: "px",
				description: "Blur radius under the glass.",
			},
			{
				name: "edgeWidth",
				kind: "number",
				...
				step: 0.01,
				description:
					"Fraction of the slab that is bevel — all of the bending and most of the glare lives there.",
			},
			{
				name: "glare",
				kind: "number",
				...
				max: 1,
				step: 0.05,
				description: "Fresnel rim and travelling specular strength.",
			},
			{
				name: "slabWidth",
				kind: "number",
				...
				step: 1,
				unit: "%",
				description: "Slab width as a fraction of the container.",
			},
			{
				name: "scene",
				kind: "enum",
				default: "blobs",
				options: ["blobs", "stripes", "checker"],
				description:
					"The procedural backdrop being refracted. High-frequency scenes show the dispersion hardest.",
			},
			{
				name: "tint",
				kind: "color",
				default: "#e9e6ff",
				description: "Glass body tint.",
			},
		],
	},
];
